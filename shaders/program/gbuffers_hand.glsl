...
#if (defined ADVANCED_MATERIALS || defined PARALLAX || defined GENERATED_NORMALS)
varying float dist;
...
#if (defined ADVANCED_MATERIALS || defined GENERATED_EMISSION || defined GENERATED_SPECULAR || defined PARALLAX || defined GENERATED_NORMALS)
...
void main() {
	...
	if (albedo.a > 0.001) {
		...
		#if (defined OVERWORLD || defined END) && (defined ADVANCED_MATERIALS || defined GENERATED_EMISSION || defined GENERATED_SPECULAR || defined PARALLAX || defined GENERATED_NORMALS) && SPECULAR_HIGHLIGHT > 0
		...
		#if (defined ADVANCED_MATERIALS || defined GENERATED_EMISSION || defined GENERATED_SPECULAR || defined PARALLAX || defined GENERATED_NORMALS) && defined REFLECTION_SPECULAR && defined REFLECTION_ROUGH
    ...
    gl_FragData[0] = albedo;
		...
		#if (defined ADVANCED_MATERIALS || defined GENERATED_EMISSION || defined GENERATED_SPECULAR || defined PARALLAX || defined GENERATED_NORMALS) && defined REFLECTION_SPECULAR
		/* DRAWBUFFERS:08367 */
