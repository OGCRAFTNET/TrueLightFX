...
#if defined REFLECTION_RAIN || defined RAIN_PUDDLES || defined EMISSIVE_FLOWERS
...
void main() {
	...
	if (albedo.a > 0.001) {
		...
		albedo.rgb += GetSpecularHighlight(newNormal, viewPos, 0.3 * length(albedo.rgb) + smoothness * 0.7, baseReflectance,
