...
void main() {
	...
	if (albedo.a > 0.001) {
		...
		if (water > 0.5) {
			...
			#elif WATER_NORMALS == 3 && (defined ADVANCED_MATERIALS || defined GENERATED_EMISSION || defined GENERATED_SPECULAR || defined PARALLAX || defined GENERATED_NORMALS)
		...
		if (water > 0.5 || ((translucent + glass) > 0.5 && albedo.a < 0.95)) {
			...
			#if (defined OVERWORLD || defined END) && (defined ADVANCED_MATERIALS || defined GENERATED_EMISSION || defined GENERATED_SPECULAR || defined PARALLAX || defined GENERATED_NORMALS) && SPECULAR_HIGHLIGHT == 2
